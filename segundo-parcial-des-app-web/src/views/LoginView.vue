  ...
  <div class="d-flex align-items-center justify-content-center min-vh-100" style="background: var(--color-bg);">
    <div style="max-width: 420px; width: 100%; padding: 24px;">
      ...
      <div style="background: var(--color-surface); border: 1px solid var(--color-border); border-radius: var(--radius); padding: 36px 32px;">
        ...
        <button @click="login" class="btn btn-accent w-100 py-2 mb-3" style="font-family: 'Bebas Neue', sans-serif; font-size: 1.2rem; letter-spacing: 3px;">
          ENTRAR
        </button>

        <p class="text-center small" style="color: var(--color-muted);">
